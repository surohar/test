...
const quizdata=[
      {
        ...
        options:["avez", "sommes", "avons"],
        answer:"avons",
        category:3
      },
      {
        question:".... opéra est de Mozart.",
        options:["ce", "cette", "cet"],
        answer:"cet",
        category:3
      },
      {
        question:" Nous allons à Paris .... voiture.",
        options:["en", "avec", "par"],
        answer:"en",
        category:1
      },
      {
        question:"Parle t-il à Isabelle ? Oui, il .... parle.",
        options:["elle", "lui", "me"],
        answer:"lui",
        category:2
      },
      {
        question:"Allez-vous au cinéma ? Oui, j'.... vais.",
        options:["y", "en", "il"],
        answer:"y",
        category:1
      },
      {
        question:" Boit-il du vin ? Oui, il .... boit.",
        options:["y", "le", "en"],
        answer:"en",
        category:3
      },
      {
        question:" Nous .... en vacances demain.",
        options:["serons", "étions", "aurons"],
        answer:"serons",
        category:1
      },
      {
        question:"Quand j'étais enfant, nous.... une grande maison.",
        options:["étions", "avions", "avons"],
        answer:"avions",
        category:2
      },
      {
        question:"Vous serez sage : ..... sage !",
        options:["sois", "Oêtes", "soyez"],
        answer:"soyez",
        category:3
      },
      {
        question:"Je suis resté en France ..... 2 semaines.",
        options:["depuis", "Embark", "Ocular", "Apprehensible"],
        answer:"Ocular",
        category:2
      },
      {
        question:"Able to reinforce sound by sympathetic vibrations",
        options:["Resonance", "pendant", "dans"],
        answer:"pendant",
        category:2
      },
      {
        question:"Quelles vacances, il ne cesse.... pleuvoir.",
        options:["à", "de", "par"],
        answer:"de",
        category:2
      }
